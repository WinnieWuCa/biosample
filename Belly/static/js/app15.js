...
function buildCharts(sample) {
  console.log(`buildCharts() sample selected ${sample}`); 
// @TODO: Build a Pie Chart
  ...
  var data = [{  
    ...
    console.log(`buildCharts() response.sample_values = ${response.sample_values}`); 
    console.log(`buildCharts() response.otu_ids = ${response.otu_ids}`); 
...
// @TODO:Build a Bubble Chart using the sample data
  ...
  var data = [trace1];
  var layout = {
  title: "Bubble Chart - Belly Button",
  showlegend: false,
  height: 600,
  width: 600
  };
